-- Drop the old 9-parameter version of update_audit_session_with_token
DROP FUNCTION IF EXISTS public.update_audit_session_with_token(UUID, UUID, TEXT, INTEGER, JSONB, JSONB, JSONB, JSONB, BOOLEAN);

-- Ensure only the new 11-parameter version exists
